...
const app = express()
const url = 'mongodb+srv://superadmin:ayayun.1999@cluster0.jgurt.mongodb.net/sample_weatherdata?retryWrites=true&w=majority'
...
app.get('/weather', async (req, res) => {
    try {
        ...
        let data = []
        await cursor.forEach(doc => data.push("position : ",dos.position , "callLetters" ,doc.callLetters , "airTemperature" ,doc.airTemperature , "ts" , doc.ts))
